...
const Reasons = () => {
  ...
  return (
    <div className="p-6 bg-white shadow-md rounded-lg w-full h-full">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-gray-800">Reasons</h2>
  ...
  <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
    <div className="bg-white p-6 rounded-lg shadow-lg w-96">
      ...
      <p className="text-sm text-gray-500">Select the reasons of the employee</p>
          ...
          <tbody>
            {reasons.map((reason, index) => (
              <tr key={index} className="border-b hover:bg-gray-50 transition">
                ...
                <td className="p-3 text-purple-600 font-semibold">{reason.code}</td>
                <td className="p-3">{reason.description}</td>
                <td className="p-3">{reason.updated}</td>
