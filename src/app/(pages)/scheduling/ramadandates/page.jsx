  ...
  return (
    <div className="p-6 bg-white shadow-md rounded-lg w-full h-full">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-gray-800">Set Ramadan Dates</h2>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
          <div className="bg-white rounded-2xl p-8 shadow-xl w-full max-w-4xl">
            <h2 className="text-2xl font-semibold text-center mb-6">Ramadan Dates</h2>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium mb-1">
                  Ramadan Date (English) <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium mb-1">
                  Ramadan Date (العربية) <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
        ...
        <table className="w-full border-collapse">
          <thead className="bg-gray-100 border-b sticky top-0">
            <tr>
              ...
              <th className="p-3 text-left font-medium text-gray-600">Ramadan(English)</th>
              <th className="p-3 text-left font-medium text-gray-600">Ramadan</th>
              <th className="p-3 text-left font-medium text-gray-600">From Date</th>
              <th className="p-3 text-left font-medium text-gray-600">T0 Date</th>
              <th className="p-3 text-left font-medium text-gray-600"></th>
            </tr>
          </thead>

          <tbody>
            {ramadandates.map((ramadandate, index) => (
              <tr key={index} className="border-b hover:bg-gray-50 transition">
                <td className="p-3">
                  <input type="checkbox" className="accent-purple-600" />
                </td>
                <td className="p-3 text-purple-600 font-semibold">{ramadandate.HolidayName}</td>
                <td className="p-3">{ramadandate.FromDate}</td>
                <td className="p-3">{ramadandate.ToDate}</td>
                <td className="p-3">{ramadandate.PublicHoliday}</td>
