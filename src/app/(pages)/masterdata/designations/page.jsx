...
const Designations = () => {
  ...
  return (
    <div className="p-6 bg-white shadow-md rounded-lg w-full h-full">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-gray-800">Designations</h2>
  ...
  <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
    <div className="bg-white p-6 rounded-lg shadow-lg w-96">
      ...
      <p className="text-sm text-gray-500">Select the designations of the employee</p>
          ...
          <tbody>
            {designations.map((designation, index) => (
              <tr key={index} className="border-b hover:bg-gray-50 transition">
                ...
                <td className="p-3 text-purple-600 font-semibold">{designation.code}</td>
                <td className="p-3">{designation.description}</td>
                <td className="p-3">{designation.updated}</td>
