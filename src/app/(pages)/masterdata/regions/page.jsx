...
const Regions = () => {
  ...
  <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
    <div className="bg-white p-6 rounded-lg shadow-lg w-96">
      ...
      <p className="text-sm text-gray-500">Select the regions of the employee</p>
          ...
          <tbody>
            {regions.map((region, index) => (
              <tr key={index} className="border-b hover:bg-gray-50 transition">
                ...
                <td className="p-3 text-purple-600 font-semibold">{region.code}</td>
                <td className="p-3">{region.description}</td>
                <td className="p-3">{region.updated}</td>
