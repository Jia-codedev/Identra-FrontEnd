  ...
  return (
    <div className="p-6 bg-white shadow-md rounded-lg w-full h-full">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-gray-800">Nationalities</h2>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <p className="text-sm text-gray-500">Select the Nationalities of the employee</p>

            {/* Input Fields */}
            <div className="mt-4">
              <label className="block text-sm font-medium">Code *</label>
              <input type="text" placeholder="Enter code" className="w-full p-2 border rounded-lg" />
            </div>

            <div className="mt-2">
              <label className="block text-sm font-medium">Description (English) *</label>
              <input type="text" placeholder="Enter Description" className="w-full p-2 border rounded-lg" />
            </div>
          ...
          <tbody>
            {nationalities.map((nationality, index) => (
              <tr key={index} className="border-b hover:bg-gray-50 transition">
                ...
                <td className="p-3 text-purple-600 font-semibold">{nationality.code}</td>
                <td className="p-3">{nationality.description}</td>
                <td className="p-3">{nationality.updated}</td>
