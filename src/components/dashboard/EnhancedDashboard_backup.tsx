  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <Button
                ...
                className="flex items-center gap-2 bg-muted backdrop-blur-sm border-white/20 shadow-lg"
              >
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Button variant="outline" size="sm" className="bg-white/80 backdrop-blur-sm border-white/20 hover:bg-white/90 shadow-lg">
        ...
        <motion.div variants={itemVariants}>
          {canViewTeamDashboard ? (
            <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as any)}>
              <TabsList className="grid w-full max-w-md grid-cols-2 mb-6 backdrop-blur-sm border-white/20 shadow-lg">
                <TabsTrigger value="employee" className="flex items-center gap-2data-[state=active]:bg-primary data-[state=active]:text-white">
                  <User className="w-4 h-4" />
                  Self View
                </TabsTrigger>
                <TabsTrigger value="team" className="flex items-center gap-2data-[state=active]:bg-primary data-[state=active]:text-white">
        ...
        {/* Enhanced Footer */}
        <motion.div variants={itemVariants}>
          <Card className="p-4 mt-8 bg-white/60 backdrop-blur-sm border-white/20 shadow-xl">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs sm:text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2">
                <div className="px-3 py-1 bg-gradient-to-r from-blue-500/20 to-purple-600/20 rounded-full text-xs font-medium">
