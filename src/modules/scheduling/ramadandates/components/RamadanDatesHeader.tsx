        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 sm:gap-6">
          <div className="flex-1">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-muted-foreground font-normal mb-2">
              {t('scheduling.ramadanDates.subtitle')}
            </p>
            {selectedCount > 0 && (
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <Button onClick={onAddNew} className="gap-2 text-xs sm:text-sm h-8 sm:h-9">
              <CalendarDays size={14} className="sm:size-4" />
              <span className="hidden sm:inline">{t('scheduling.ramadanDates.addRamadanDate')}</span>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {/* Month Filter */}
              <div className="flex items-center gap-1">
                <CalendarDays size={14} className="sm:size-4 text-muted-foreground hidden sm:block" />
                <Select
