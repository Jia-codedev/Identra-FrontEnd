            ...
            <div className="flex items-center">
              ...
              >
                ...
                <button
                  ...
                  aria-pressed={viewMode === "calendar"}
                  onClick={() =>
                    onViewModeChange && onViewModeChange("calendar")
                  }
                  className={`flex items-center gap-2 px-3 py-1 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-ring ${
                    viewMode === "calendar"
                      ? "bg-card shadow text-card-foreground"
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
            <div className="flex flex-wrap gap-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <Select
                  value={
                    filters.recurring_flag === undefined
                      ? "all"
                      : filters.recurring_flag.toString()
                  }
                  onValueChange={(value) =>
                    onFiltersChange({
                      recurring_flag:
                ...
                >
                  <SelectTrigger className="w-[110px] sm:w-[160px] h-8 sm:h-9 text-xs sm:text-sm">
                    <SelectValue
                      placeholder={t("scheduling.holidays.recurringFilter")}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="all">
                      {t("scheduling.holidays.allTypes")}
                    </SelectItem>
                    <SelectItem value="true">
                      {t("scheduling.holidays.recurringOnly")}
                    </SelectItem>
                    <SelectItem value="false">
                      {t("scheduling.holidays.oneTimeOnly")}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="flex items-center gap-1">
                ...
                <Select
                  value={
                    filters.public_holiday_flag === undefined
                      ? "all"
                      : filters.public_holiday_flag.toString()
                  }
                  onValueChange={(value) =>
                    onFiltersChange({
                      public_holiday_flag:
                ...
                >
                  <SelectTrigger className="w-[110px] sm:w-[160px] h-8 sm:h-9 text-xs sm:text-sm">
                    <SelectValue
                      placeholder={t("scheduling.holidays.publicHolidayFilter")}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="all">
                      {t("scheduling.holidays.allHolidays")}
                    </SelectItem>
                    <SelectItem value="true">
                      {t("scheduling.holidays.publicOnly")}
                    </SelectItem>
                    <SelectItem value="false">
                      {t("scheduling.holidays.privateOnly")}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
