...
const OrganizationStructurePage: React.FC = () => {
  ...
  const handleExport = () => {
    ...
    const exportFileDefaultName = `organization-structure-${
  ...
  return (
    <div
      className={`p-2 space-y-6-lg ${isRTL ? "text-right" : "text-left"}`}
      dir={isRTL ? "rtl" : "ltr"}
    >
      {/* Header */}
      <div
      ...
      <div className="border rounded p-1">
        ...
        {isLoading ? (
          ...
          <div
            className={`flex flex-col items-center justify-center text-muted-foreground space-y-2 ${
          ...
          >
            ...
            <p className="text-sm">
              {t("masterdata.organizations.structure.noOrganizationsFound")}
            </p>
            <Button
              variant="outline"
