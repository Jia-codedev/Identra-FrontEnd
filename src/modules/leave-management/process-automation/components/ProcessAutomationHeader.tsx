...
export const ProcessAutomationHeader: React.FC<ProcessAutomationHeaderProps> = ({
  search,
  onSearchChange,
  onAdd,
  selectedCount,
      ...
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
        <div className="flex-1">
          <h1 className="text-3xl md:text-4xl font-bold text-primary tracking-tight leading-tight mb-1">
            {t('leaveManagement.processAutomation.title') || t('leaveManagement.processAutomation')}
          </h1>
          <p className="text-base md:text-lg text-muted-foreground font-normal mb-2">
            {t('leaveManagement.processAutomation.description')}
          </p>
          {selectedCount > 0 && (
